...
//     productName: isTablet ? 20 : (isSmallDevice ? 15 : 17),
//     price: isTablet ? 22 : (isSmallDevice ? 16 : 18),
...
//         // Only set ad images if we have some, otherwise use default
...
//   // Auto-scroll advertisement - Only if we have more than 1 ad
//   useEffect(() => {
...
//       style={styles.card}
//       onPress={() =>
//         navigation.navigate("ProductScreen4", {
//           product: item,
//         })
//       }
//     >
...
//           <Text style={[styles.priceText, { fontSize: responsive.fontSize.price }]}>
//             ₹{item.price || "0.00"}
//           </Text>
//           {item.originalPrice && (
...
//             onPress={() => {
//               if (item.phoneNumber) {
//                 Linking.openURL(`tel:${item.phoneNumber.replace(/\s/g, '')}`);
//               } else {
...
//                 const number = item.whatsappNumber.replace(/\s/g, '');
...
//     // Don't render ads if there are none
...
//         <Ionicons 
//           name="search" 
//           size={responsive.iconSize.search} 
//           color="#64748B" 
...
//   /* HEADER STYLES - Perfect Centering */
//   headerContainer: {
...
//   /* ADVERTISEMENT STYLES - Full Edge */
//   adWrapper: {
//     width: width,
//     position: 'relative',
//     backgroundColor: '#000',
          ...
          <View style={styles.dotContainer}>
            {adImages.map((_, index) => (
              <View
                ...
                style={[
                  styles.dot,
                  currentAdIndex === index && styles.activeDot,
                ]}
              />
            ))}
          </View>
