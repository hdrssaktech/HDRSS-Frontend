...
//     searchText.length > 0 ? filteredTowns : towns; 
...
//             <TouchableOpacity
//               onPress={() =>
//                 navigation.navigate("TownPage2", { town: selectedTown ,DistrictId:districtId ,DistrictName:districtName})
//               }
//             >
//               <Image
...
//     <TouchableOpacity
//       style={styles.card}
//       onPress={() => navigation.navigate("TownPage2", { town: item,townId :item.id })}
//     >
//       <Image
