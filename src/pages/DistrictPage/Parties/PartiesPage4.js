...
const PartiesPage4 = () => {
  ...
  const renderGalleryItem = ({ item: imgUrl }) => (
    <TouchableOpacity
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      {/* Header (same as DistrictAssemblyPage4) */}
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.profileSection, isTablet && styles.profileSectionTablet]}>
          ...
          <View style={styles.partyBadge}>
            <Text style={[styles.partyText, isTablet && styles.partyTextTablet]}>
              {item?.title || "Party"} {item?.role ? `- ${item.role}` : ""}
            </Text>
          </View>
        ...
        {/* Video Section (inline like DistrictAssemblyPage4) */}
        {videoId ? (
...
const styles = StyleSheet.create({
  ...
  // Profile
  profileSection: { padding: 20, alignItems: "center", backgroundColor: "#ffffff" },
  profileSectionTablet: { padding: 30 },
  ...
  profileImageTablet: { width: 200, height: 200, borderRadius: 20, borderWidth: 3 },
  name: {
    fontSize: 23,
    fontWeight: "bold",
    color: "#333",
  ...
  nameTablet: { fontSize: 32, marginBottom: 12 },
  ...
  partyText: { fontSize: 16, color: "#8B0000", fontWeight: "600" },
  partyTextTablet: { fontSize: 18 },
  ...
  actionButton: { alignItems: "center", justifyContent: "center", marginHorizontal: 25 },
  iconCircle: {
    width: 60,
    height: 60,
    borderRadius: 30,
  ...
  iconCircleTablet: { width: 75, height: 75, borderRadius: 37.5 },
  actionText: { fontSize: 14, color: "#8B0000", fontWeight: "500" },
  actionTextTablet: { fontSize: 16 },

  separator: { height: 10, backgroundColor: "#f5f5f5", width: "100%" },

  // About
  aboutSection: { padding: 20, backgroundColor: "#ffffff" },
  aboutSectionTablet: { padding: 30 },
  sectionTitle: { fontSize: 20, fontWeight: "bold", color: "#333", marginBottom: 12 },
  sectionTitleTablet: { fontSize: 24, marginBottom: 16 },
  aboutText: { fontSize: 16, color: "#666", lineHeight: 24, marginBottom: 12 },
  aboutTextTablet: { fontSize: 18, lineHeight: 28 },
  readMoreButton: { flexDirection: "row", alignItems: "center", alignSelf: "flex-start" },
  readMoreText: { fontSize: 16, color: "#8B0000", fontWeight: "600", marginRight: 4 },
  readMoreTextTablet: { fontSize: 18 },

  // Gallery
  gallerySection: { padding: 20, backgroundColor: "#ffffff" },
  gallerySectionTablet: { padding: 30 },
  sectionHeader: {
    flexDirection: "row",
  ...
  galleryCount: { fontSize: 16, color: "#8B0000", fontWeight: "500" },
  galleryCountTablet: { fontSize: 18 },
  galleryContainer: { paddingRight: 20 },
  galleryItem: { marginRight: 15, borderRadius: 12, overflow: "hidden" },
  galleryItemTablet: { marginRight: 18 },
  galleryImage: { width: 120, height: 120 },
  galleryImageTablet: { width: 150, height: 150 },

  // Video
  videoSection: { backgroundColor: "#ffffff" },
  videoHeader: {
    paddingHorizontal: 20,
    paddingTop: 20,
    paddingBottom: 15,
  ...
  videoHeaderTablet: { paddingHorizontal: 30, paddingTop: 25, paddingBottom: 18 },
  videoWrapper: { width: "100%", backgroundColor: "#000", alignItems: "center" },

  bottomSpacing: { height: 25 },
  bottomSpacingTablet: { height: 35 },
});
