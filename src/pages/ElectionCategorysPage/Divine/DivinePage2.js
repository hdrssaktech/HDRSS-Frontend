...
export default function DivinePage2() {
  ...
  const renderItem = ({ item }) => (
    ...
    >
      ...
      {/* Dark footer - matching DivinePage1 */}
      <View
        style={[
          styles.cardFooter,
          {
...
const styles = StyleSheet.create({
  safe: { 
    flex: 1, 
    backgroundColor: "#d4cea6" // Matching DivinePage1 background
  },
  ...
  filterBar: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "rgba(255,255,255,0.5)", // Matching DivinePage1
    borderBottomWidth: 1,
  ...
  /* ── CARD - Matching DivinePage1 styles ── */
  card: {
    backgroundColor: "#FFFDF8", // Matching DivinePage1
    overflow: "hidden",
    elevation: 4,
    shadowColor: "#000",
    shadowOpacity: 0.10,
  ...
  imageContainer: {
    width: "100%",
    backgroundColor: "#1a0a00", // Matching DivinePage1
  },
  ...
  cardFooter: {
    ...
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#301913", // Dark footer matching DivinePage1
    paddingHorizontal: 8,
    paddingVertical: 7,
    gap: 4,
    minHeight: 32,
