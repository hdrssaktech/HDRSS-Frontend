...
export default function StoryPage1() {
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() => navigation.navigate("StoryPage2", { storyItem: item })}
    >
      ...
      >
        ...
        >
          <Ionicons name="chevron-forward" size={isTablet ? 11 : 10} color="#87584d" />
        </View>
      </View>
    </TouchableOpacity>
  );
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      {/* FILTER BAR — exactly like the மந்திரம் screenshot */}
      {stories.length > 0 && (
        <View
          style={[
            styles.filterBar,
      ...
      <FlatList
        ...
        contentContainerStyle={[
          ...
          filteredStories.length === 0 && styles.emptyContent,
          {
        ...
        columnWrapperStyle={{ gap: GAP, marginBottom: GAP, justifyContent: "flex-start" }}
        showsVerticalScrollIndicator={false}
        ListEmptyComponent={
          <View style={styles.center}>
            ...
            >
              <Ionicons name="book-outline" size={isTablet ? 50 : 40} color="#93210A" />
            </View>
