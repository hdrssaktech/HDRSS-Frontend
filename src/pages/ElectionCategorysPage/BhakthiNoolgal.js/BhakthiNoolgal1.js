...
export default function SloganPage1() {
  ...
  // ── Precise card width calculation (from SloganPage1) ──
    ...
    <SafeAreaView style={styles.safe}>
      ...
      {types.length > 5 && (
        ...
        >
          ...
          <Text style={[styles.filterResultCount, { fontSize: isTablet ? 13 : 11 }]}>
            மொத்தம் {filteredTypes.length}
          </Text>
        </View>
      )}
        ...
        ListEmptyComponent={
          <View style={styles.center}>
            ...
            <Text style={[styles.emptySubtitle, { fontSize: isTablet ? 14 : 12 }]}>
              No slogans found for this filter
            </Text>
          </View>
        }
      />
...
const styles = StyleSheet.create({
  // ── safe background: SloganPage1 color ──
  ...
  /* ── FILTER BAR: SloganPage1 bg color ── */
  filterBar: {
    flexDirection: "row",
    alignItems: "center",
  ...
  // Fixed: RN uses backgroundColor not background: linear-gradient
  imageOverlay: {
    position: "absolute",
    bottom: 0,
    left: 0,
    right: 0,
    height: "30%",
    backgroundColor: "rgba(147,33,10,0.15)",
  },
  // Dark maroon footer with white text (SloganPage1 style)
  cardFooter: {
    flexDirection: "row",
    alignItems: "center",
  ...
  // White circle arrow (SloganPage1 style)
  arrowDot: {
  ...
  emptySubtitle: { color: "#aaa", fontWeight: "50" },
});