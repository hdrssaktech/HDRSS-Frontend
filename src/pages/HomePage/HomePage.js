...
const getStyles = (isTablet) =>
  StyleSheet.create({
    container: {
      flex: 1,
      backgroundColor: "#F5E9D3", // vintage parchment fallback
    },
    ...
    backgroundImage: {
      position: "absolute",
      opacity: 0.10,
      tintColor: "#8B5E34", // sepia tint — gives an "old ink on palm-leaf" feel
    },

    overlay: {
      flex: 1,
      backgroundColor: "rgba(250, 235, 200, 0.55)", // warm sepia wash instead of pink
    },
